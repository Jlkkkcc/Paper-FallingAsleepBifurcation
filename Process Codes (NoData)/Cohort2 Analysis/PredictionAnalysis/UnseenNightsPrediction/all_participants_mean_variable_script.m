...
% 1) Predicting the S-variable for the unseen nights based on a number of
% selected observed nights
% 2) Calculating the cosine similarity values between the predicted
% S-variables for unseen nights calculated using sleep parameters from 
% other observed nights and true S-variables to assess the quality of sleep
% trajetory modelling 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
