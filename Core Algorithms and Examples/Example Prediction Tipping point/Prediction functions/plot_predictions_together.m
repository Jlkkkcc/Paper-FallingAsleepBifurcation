...
function plot_predictions_together(estimatedSVariables, criticalSValue, globalMin,yl,MdlTip)
...
for n_n = 1:numSubplots
    ...
    uncut_xx_smoothed = smoothdata(distPerNight1, 'movmedian', [smoothingWindow, 0], 'omitnan');
    ...
    % Adding Model tipping point line
    line([MdlTip(n_n),MdlTip(n_n)],ax.YLim,'LineStyle','--','LineWidth',2,'Color','b');
    hold off;
