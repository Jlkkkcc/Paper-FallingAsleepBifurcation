...
% tvec_now: the Time vector of the Sleep distance dynamics
...
[t,dd] = ode45(@(t,x) harvest(t,x,params),tvec_now,x_ini);
figure
...
% Fit R-square under this parameter
...
[params_optim,rsq_ini,mse_init,rsq_final,mse_final,dd,iffail1] = finetune_bif_rev(param_tuned,xx_smooth,tvec_now,xini,[]);
